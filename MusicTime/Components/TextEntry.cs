...
namespace MusicTime.Components
{
    public class TextEntry : Control, OpaticControl
    {
        ...
        private Color backColor = Color.FromArgb(236, 240, 241);

        public Color BackGroundColor
        {
            get { return backColor; }
            set { backColor = value; TB.BackColor = value; }
        }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            Pen pen = new Pen(Mix(BackColor, backColor, opacity));
            ...
            if (TB.Text.Length == 0 && !TB.Focused)
            {
                ...
                pen = new Pen(Mix(BackColor, DefaultTextColor, opacity));
